...
Section "Main Application Files" SEC01
  ...
  File "..\..\..\dist\lib\json-simple-1.1.1.jar"  
  File "..\..\..\dist\lib\jna-4.5.1.jar"  
  File "..\..\..\dist\lib\jna-platform-4.5.1.jar"  
  File "..\..\..\dist\lib\log4j-1.2.17.jar"  
  File "..\..\..\dist\lib\slf4j-api-1.7.25.jar"  
  File "..\..\..\dist\lib\slf4j-log4j12-1.7.25.jar"  
  File "..\..\..\dist\lib\SystemTray-3.14.jar"  
  File "..\..\..\dist\lib\javassist-3.22.0-GA.jar"
  File "..\..\..\dist\lib\commons-logging-1.2.jar"
  File "..\..\..\dist\lib\httpasyncclient-4.0.2.jar"
  File "..\..\..\dist\lib\httpclient-4.3.6.jar"
  File "..\..\..\dist\lib\httpcore-4.3.3.jar"
  File "..\..\..\dist\lib\httpcore-nio-4.3.3.jar"
  File "..\..\..\dist\lib\httpmime-4.3.6.jar"
...
Section Uninstall
  ...
  Delete "$INSTDIR\lib\httpasyncclient-4.0.2.jar"
  Delete "$INSTDIR\lib\httpclient-4.3.6.jar"
  Delete "$INSTDIR\lib\httpcore-4.3.3.jar"
  Delete "$INSTDIR\lib\httpcore-nio-4.3.3.jar"
  ...
  Delete "$INSTDIR\lib\jna-4.5.1.jar"
  Delete "$INSTDIR\lib\jna-platform-4.5.1.jar"
  Delete "$INSTDIR\lib\log4j-1.2.17.jar"
  Delete "$INSTDIR\lib\slf4j-api-1.7.25.jar"
  Delete "$INSTDIR\lib\slf4j-log4j12-1.7.25.jar"
  Delete "$INSTDIR\lib\SystemTray-3.14.jar"
  Delete "$INSTDIR\lib\javassist-3.22.0-GA.jar"
  Delete "$INSTDIR\logs\.gitkeep"
